...
urlpatterns = [
    ...
    path('udops/user/access_permission/',views.grant_dataset.as_view()),
    path('udops/user/remove_permission/',views.remove_user_dataset.as_view()),
    path('udops/user/dataset_access_list_write/',views.grant_dataset_list_write.as_view()),
    path('udops/user/dataset_access_list_read/',views.grant_dataset_list_read.as_view()),
